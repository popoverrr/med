...
export interface SceneParams {
  ...
  distortion: number;
  clarity: number;
  /** 0 — глубокая вода, 1 — прозрачная aqua */
  colorMix: number;
...
export const params: SceneParams = {
  ...
  distortion: 0.05, clarity: 0, colorMix: 0, spread: 0, column: 0, noise: 0.25, fog: 0, opacity: 1, speed: 0.2,
};

export const KEYFRAMES: Record<SceneKey, SceneParams> = {
  // distortion держим низким: крупные «бугры» превращали каплю в клетку. Вода = почти сфера + мелкая рябь.
  hero:      { camZ: 6.2, blobX: 1.35, blobY: 0.05, blobScale: 1.15, stretch: 0.0, rotZ: 0.0,  distortion: 0.05, clarity: 0.35, colorMix: 0.0,  spread: 0.0, column: 0.0, noise: 0.25, fog: 0.0, opacity: 1.0, speed: 0.2 },
  // Эксперт: капля уходит в верхний правый угол и уменьшается — главным в кадре становится портрет специалиста
  expert:    { camZ: 6.6, blobX: 3.25, blobY: 1.35, blobScale: 0.5, stretch: 0.0, rotZ: 0.0,  distortion: 0.04, clarity: 0.5, colorMix: 0.1,  spread: 0.0, column: 0.0, noise: 0.2, fog: 0.0, opacity: 1.0, speed: 0.15 },
  what:      { camZ: 6.9, blobX: 2.6, blobY: 0.2, blobScale: 0.95, stretch: 0.55, rotZ: -0.25, distortion: 0.07, clarity: 0.15, colorMix: 0.05, spread: 0.0, column: 0.0, noise: 0.25, fog: 0.0, opacity: 1.0, speed: 0.3 },
...
export const PORTRAIT_POSES: Record<SceneKey, PortraitPose> = {
  ...
  expert:    { fx: 0.9,   fy: 0.86,  blobScale: 0.28 },
